 ...
 * ----------------------------------------------------------------------------
 * One brand accent. Colours come from CSS variables defined in index.css so
 * light/dark themes swap atomically. Inter Variable for body, Inter Display
 * for headings (Linear's stack). Constrained shadow + radius scales.
 */
module.exports = {
  darkMode: 'class',
  ...
  theme: {
    extend: {
      ...
      colors: {
        // Single brand accent. Used for primary CTAs, focus rings, "active"
        // affordances. Don't use it for decoration.
        brand: {
          DEFAULT: 'rgb(var(--brand) / <alpha-value>)',
          fg: 'rgb(var(--brand-fg) / <alpha-value>)',
          subtle: 'rgb(var(--brand-subtle) / <alpha-value>)',
        },
        // Semantic surfaces. Map to CSS variables that swap with the theme.
        surface: {
      ...
      // Constrained shadow scale — three steps + a focus ring.
      boxShadow: {
      ...
      transitionTimingFunction: {
        // Linear's easing — feels noticeably better than ease-out.
